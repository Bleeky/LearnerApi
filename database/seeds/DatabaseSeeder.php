...
class ModuleTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$diapo2 = Diapo::create(['content'   => '[{"type":"2","data":"Diapo 1","img": "https://lh5.googleusercontent.com/-dAe2v_8abKQ/VNnxJIEqFRI/AAAAAAAACcE/7KxoTvM-37w/s1338-no/2015-02-10.jpg"}]',
								 'module_id' => $module->id,
								 'prev_id'   => $diapo1->id,
		]);
		...
		$diapo3 = Diapo::create(['content'   => '[{"type":"2","data":"Diapo 1","img": "https://lh5.googleusercontent.com/-dAe2v_8abKQ/VNnxJIEqFRI/AAAAAAAACcE/7KxoTvM-37w/s1338-no/2015-02-10.jpg"}]',
								 'module_id' => $module->id,
								 'prev_id'   => $diapo2->id,
		]);
