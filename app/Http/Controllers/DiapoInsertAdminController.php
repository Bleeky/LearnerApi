...
class DiapoInsertAdminController extends AdminController
{
    ...
    public function postInsertFromFormQuestion1(FormQuestion1Request $request)
    {
        ...
        return view('diapos.insert')->with('id', $update['diapo-id'])->with('module_id', $update['module_id'])->withErrors(['Error' => 'You have to put only one answer at true']);
    }

    public function postInsertFromFormQuestion3(FormQuestion1Request $request)
    {
        $update = $request->all();
        ...
        return view('diapos.insert')->with('id', $update['diapo-id'])->with('module_id', $update['module_id'])->withErrors(['Error' => 'You have to put at least two answer at true']);
    }
